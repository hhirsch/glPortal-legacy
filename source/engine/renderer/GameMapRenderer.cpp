...
namespace glPortal {
  namespace engine{
	...
	this->executeLegacyRenderer();
      }

      /**
       * Legacy renderer pending rewrite/removal
       */
      void GameMapRenderer::executeLegacyRenderer(){
	...
	glVertex3f(x + 0.3f, y + 1.0f, z - 0.3f);    // Top Right Of The Quad (Top)
	glVertex3f(x - 0.3f, y + 1.0f, z - 0.3f);    // Top Left Of The Quad (Top)
	glVertex3f(x - 0.3f, y + 1.0f, z + 0.3f);    // Bottom Left Of The Quad (Top)
	glVertex3f(x + 0.3f, y + 1.0f, z + 0.3f);    // Bottom Right Of The Quad (Top)
	glColor3f(1.0f,0.5f,0.0f);    // Color Orange
	glVertex3f(x + 0.3f, y - 1.0f, z + 0.3f);    // Top Right Of The Quad (Bottom)
	glVertex3f(x - 0.3f, y - 1.0f, z + 0.3f);    // Top Left Of The Quad (Bottom)
	glVertex3f(x - 0.3f, y - 1.0f, z - 0.3f);    // Bottom Left Of The Quad (Bottom)
	glVertex3f(x + 0.3f, y - 1.0f, z - 0.3f);    // Bottom Right Of The Quad (Bottom)
	glColor3f(1.0f,0.0f,0.0f);    // Color Red    
	glVertex3f(x + 0.3f, y + 1.0f, z + 0.3f);    // Top Right Of The Quad (Front)
	glVertex3f(x - 0.3f, y + 1.0f, z + 0.3f);    // Top Left Of The Quad (Front)
	glVertex3f(x - 0.3f, y - 1.0f, z + 0.3f);    // Bottom Left Of The Quad (Front)
	glVertex3f(x + 0.3f, y - 1.0f, z + 0.3f);    // Bottom Right Of The Quad (Front)
	glColor3f(1.0f,1.0f,0.0f);    // Color Yellow
	glVertex3f(x + 0.3f, y - 1.0f, z - 0.3f);    // Top Right Of The Quad (Back)
	glVertex3f(x - 0.3f, y - 1.0f, z - 0.3f);    // Top Left Of The Quad (Back)
	glVertex3f(x - 0.3f, y + 1.0f, z - 0.3f);    // Bottom Left Of The Quad (Back)
	glVertex3f(x + 0.3f, y + 1.0f, z - 0.3f);    // Bottom Right Of The Quad (Back)
	glColor3f(0.0f,0.0f,1.0f);    // Color Blue
	glVertex3f(x - 0.3f, y + 1.0f, z + 0.3f);    // Top Right Of The Quad (Left)
	glVertex3f(x - 0.3f, y + 1.0f, z - 0.3f);    // Top Left Of The Quad (Left)
	glVertex3f(x - 0.3f, y - 1.0f, z - 0.3f);    // Bottom Left Of The Quad (Left)
	glVertex3f(x - 0.3f, y - 1.0f, z + 0.3f);    // Bottom Right Of The Quad (Left)
	glColor3f(1.0f,0.0f,1.0f);    // Color Violet
	glVertex3f(x + 0.3f, y + 1.0f, z - 0.3f);    // Top Right Of The Quad (Right)
	glVertex3f(x + 0.3f, y + 1.0f, z + 0.3f);    // Top Left Of The Quad (Right)
	glVertex3f(x + 0.3f, y - 1.0f, z + 0.3f);    // Bottom Left Of The Quad (Right)
	glVertex3f(x + 0.3f, y - 1.0f, z - 0.3f);    // Bottom Right Of The Quad (Right)
